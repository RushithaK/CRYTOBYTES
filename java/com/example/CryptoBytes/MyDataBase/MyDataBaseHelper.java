package com.example.CryptoBytes.MyDB;
...
import com.example.CryptoBytes.MyModels.MyFavouritesModel;
...
public class MyDataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "CryptoBytes.db";
    ...
    private static final String DEFAULT_FAVORITE_COINS = "BTC,ETH,USD";
    ...
    public MyFavouritesModel getFavorites() {
        ...
        return new MyFavouritesModel(favoritesList, favoritesMap);
    }
    ...
    public void saveCoinFavorites(MyFavouritesModel favs) {
